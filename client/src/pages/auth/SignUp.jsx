    ...
    return (
        <div className="w-full h-full bg-amber-50 flex items-center justify-center">
            ...
            <form onSubmit={onSubmit} className="w-1/3 absolute bg-black bg-opacity-5 backdrop-blur-xl shadow-sm grid grid-rows-[30%_23%_23%_24%] z-30 rounded-xl h-1/3 ">
                ...
                <input placeholder="Username" className="pl-8 placeholder:text-gray-500 text-2xl w-full h-full transition-colors focus:bg-opacity-20 bg-black bg-opacity-0 focus:outline-none"></input>
                <input ref={emailRef} placeholder="Email" type="email" className="pl-8 placeholder:text-gray-500 text-2xl w-full h-full transition-colors focus:bg-opacity-20 bg-black bg-opacity-0 focus:outline-none"></input>
